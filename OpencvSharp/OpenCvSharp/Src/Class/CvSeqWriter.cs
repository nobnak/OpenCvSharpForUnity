...
namespace OpenCvSharp
{
    ...
    public class CvSeqWriter : DisposableCvObject
    {
            ...
            : this()
        {
            ...
            CvInvoke.cvStartAppendToSeq(seq.CvPtr, _ptr);
        }
#if LANG_JP
        /// <summary>
            ...
            : this()
        {
            ...
            CvInvoke.cvStartWriteSeq(seqFlags, headerSize, elemSize, storage.CvPtr, _ptr);
        }
#if LANG_JP
        /// <summary>
        /// ポインタから初期化
        ...
        public int HeaderSize
        {
            get
            {
                unsafe
                {
                    return ((WCvSeqWriter*)_ptr)->header_size;
                }
            }
        }
        /// <summary>
        ...
        public CvSeq Seq
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvSeqWriter*)_ptr)->seq);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvSeqBlock Block
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvSeqWriter*)_ptr)->block);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public IntPtr Ptr
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvSeqWriter*)_ptr)->ptr);
                }
            }
            internal set
            {
                unsafe
                {
                    ((WCvSeqWriter*)_ptr)->ptr = (sbyte*)value;
                }
            }
        }
        /// <summary>
        ...
        public IntPtr BlockMin
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvSeqWriter*)_ptr)->block_min);
                }
            }
        }
        /// <summary>
        ...
        public IntPtr BlockMax
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvSeqWriter*)_ptr)->block_max);
                }
            }
        }
        #endregion
        ...
        public void Flush()
        {
            CvInvoke.cvFlushSeqWriter(_ptr);
        }
        #endregion
