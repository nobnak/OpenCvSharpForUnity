    ...
    public class CvHaarClassifierCascade : DisposableCvObject
    {
...
#endif
        [Obsolete]
        public static CvHaarClassifierCascade FromDirectory(string directory, CvSize orig_window_size)
        {
            if (string.IsNullOrEmpty(directory))
                throw new ArgumentNullException("directory");
            IntPtr result = CvInvoke.cvLoadHaarClassifierCascade(directory, orig_window_size);
        ...
        public int Flags
        {
            get
            {
                unsafe
                {
                    return ((WCvHaarClassifierCascade*)_ptr)->flags;
                }
            }
        }
#if LANG_JP
        ...
        public int Count
        {
            get
            {
                unsafe
                {
                    return ((WCvHaarClassifierCascade*)_ptr)->count;
                }
            }
        }
#if LANG_JP
        ...
        public CvSize OrigWindowSize
        {
            get
            {
                unsafe
                {
                    return ((WCvHaarClassifierCascade*)_ptr)->orig_window_size;
                }
            }
        }
#if LANG_JP
        ...
        public CvSize RealWindowSize
        {
            get
            {
                unsafe
                {
                    return ((WCvHaarClassifierCascade*)_ptr)->real_window_size;
                }
            }
        }
#if LANG_JP
        ...
        public double Scale
        {
            get
            {
                unsafe
                {
                    return ((WCvHaarClassifierCascade*)_ptr)->scale;
                }
            }
        }
#if LANG_JP
        ...
        public CvHaarStageClassifier[] StageClassifier
        {
            get
            {
                unsafe
                {
                    WCvHaarClassifierCascade* p = (WCvHaarClassifierCascade*)_ptr;
        ...
        public IntPtr HidCascade
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvHaarClassifierCascade*)_ptr)->hid_cascade);
                }
            }
        }
        ...
        /// <returns></returns>
#endif
        public CvSeq HaarDetectObjects(CvArr image, CvMemStorage storage, double scale_factor)
        {
            return Cv.HaarDetectObjects(image, this, storage, scale_factor);
        }
#if LANG_JP
        /// <summary>
        /// 与えられた画像からオブジェクトを含む様な矩形領域を検出し，それらの領域を矩形の列として返す．
        ...
        /// <returns></returns>
#endif
        public CvSeq HaarDetectObjects(CvArr image, CvMemStorage storage, double scale_factor, int min_neighbors)
        {
            return Cv.HaarDetectObjects(image, this, storage, scale_factor, min_neighbors);
        }
#if LANG_JP
        /// <summary>
        /// 与えられた画像からオブジェクトを含む様な矩形領域を検出し，それらの領域を矩形の列として返す．
        ...
        /// <returns></returns>
#endif
        public CvSeq HaarDetectObjects(CvArr image, CvMemStorage storage, double scale_factor, int min_neighbors, HaarDetectionType flags, CvSize min_size)
        {
            return Cv.HaarDetectObjects(image, this, storage, scale_factor, min_neighbors, flags, min_size);
        }
        #endregion
        #region Run
#if LANG_JP
        ...
        /// <returns>positive value if the analyzed rectangle passed all the classifier stages (it is a candidate) and zero or negative value otherwise. </returns>
#endif
	    public bool Run( CvPoint pt, bool start_stage )
	    {
		    return Cv.RunHaarClassifierCascade(this, pt, start_stage);
	    }
	    #endregion 
	    #region SetImages
#if LANG_JP
...
#endif
	    public void SetImages( CvArr sum, CvArr sqsum, CvArr tilted_sum, double scale )
	    {
		    Cv.SetImagesForHaarClassifierCascade(this, sum, sqsum, tilted_sum, scale);
	    }
	    #endregion 
        #endregion
    }
