...
namespace OpenCvSharp
{
    ...
    public class CvFileStorage : DisposableCvObject
    {
        ...
        public CvFileStorage(string filename, CvMemStorage memstorage, FileStorageMode flags, string encoding)
        {
            ...
            this._ptr = CvInvoke.cvOpenFileStorage(filename, memstoragePtr, flags, encoding);
        ...
        protected override void Dispose(bool disposing)
        {
            if (!this._disposed)
            {
                ...
                try
                {
                    ...
                    if (IsEnabledDispose)
                    {
                        CvInvoke.cvReleaseFileStorage(ref _ptr);
                    }
                    this._disposed = true;
                }
                finally
        ...
        /// <returns></returns>
#endif
        public CvFileNode GetFileNode(CvFileNode map, CvStringHashNode key, bool create_missing)
        {
            return Cv.GetFileNode(this, map, key, create_missing);
        }
        #endregion
        ...
        /// <returns>One of top-level file nodes</returns>
#endif
        public CvFileNode GetRootFileNode(int stream_index)
        {
            return Cv.GetRootFileNode(this, stream_index);
        }
        #endregion
        #region GetHashedKey
#if LANG_JP
        ...
        /// <returns>The unique pointer for each particular file node name.</returns>
#endif
        public CvStringHashNode GetHashedKey(string name, bool create_missing)
        {
            return Cv.GetHashedKey(this, name, create_missing);
        }
        #endregion
        #region Read
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public int ReadIntByName(CvFileNode map, string name, int default_value)
        {
            return Cv.ReadIntByName(this, map, name, default_value);
        }
        #endregion
        #region ReadRawData
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public double ReadRealByName(CvFileNode map, string name, double default_value)
        {
            return Cv.ReadRealByName(this, map, name, default_value);
        }
        #endregion
        ...
        /// <returns></returns>
#endif
        public string ReadStringByName(CvFileNode map, string name, string default_value)
        {
            return Cv.ReadStringByName(this, map, name, default_value);
        }
        #endregion
...
#endif
        public void StartWriteStruct(string name, NodeType struct_flags)
        {
            Cv.StartWriteStruct(this, name, struct_flags);
        }
#if LANG_JP
        /// <summary>
        /// 新しい構造体の書き込みを開始する
...
#endif
        public void StartWriteStruct(string name, NodeType struct_flags, string type_name)
        {
            Cv.StartWriteStruct(this, name, struct_flags, type_name);
        }
        #endregion
        #region Write
#if LANG_JP
...
#endif
        public void Write(string name, CvArr ptr)
        {
            Cv.Write(this, name, ptr);
        }
#if LANG_JP
        /// <summary>
        /// オブジェクトをファイルストレージに書き込む.
...
#endif
        public void Write(string name, CvArr ptr, CvAttrList attributes)
        {
            Cv.Write(this, name, ptr, attributes);
        }
        #endregion
        #region WriteComment
#if LANG_JP
...
#endif
        public void WriteComment(string comment, bool eol_comment)
        {
            Cv.WriteComment(this, comment, eol_comment);
        }
        #endregion
...
#endif
        public void WriteFileNode(string new_node_name, CvFileNode node, bool embed)
        {
            Cv.WriteFileNode(this, new_node_name, node, embed);
        }
        #endregion
        #region WriteInt
#if LANG_JP
