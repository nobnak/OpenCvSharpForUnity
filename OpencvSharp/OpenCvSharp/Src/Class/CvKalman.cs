...
namespace OpenCvSharp
{
    ...
    public class CvKalman : DisposableCvObject
    {
        ...
        {
            this._ptr = CvInvoke.cvCreateKalman(dynam_params, measure_params, control_params);
            if (_ptr == IntPtr.Zero)
            {
        ...
        public CvMat StatePre
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvKalman*)_ptr)->state_pre);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvMat StatePost
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvKalman*)_ptr)->state_post);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvMat TransitionMatrix
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvKalman*)_ptr)->transition_matrix);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvMat ControlMatrix
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvKalman*)_ptr)->control_matrix);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvMat MeasurementMatrix
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvKalman*)_ptr)->measurement_matrix);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvMat ProcessNoiseCov
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvKalman*)_ptr)->process_noise_cov);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvMat MeasurementNoiseCov
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvKalman*)_ptr)->measurement_noise_cov);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvMat ErrorCovPre
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvKalman*)_ptr)->error_cov_pre);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvMat Gain
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvKalman*)_ptr)->gain);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvMat ErrorCovPost
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvKalman*)_ptr)->error_cov_post);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvMat Temp1
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvKalman*)_ptr)->temp1);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvMat Temp2
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvKalman*)_ptr)->temp2);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvMat Temp3
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvKalman*)_ptr)->temp3);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvMat Temp4
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvKalman*)_ptr)->temp4);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvMat Temp5
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvKalman*)_ptr)->temp5);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public unsafe float* PosterState
        {
            get
            {
                unsafe
                {
                    return ((WCvKalman*)_ptr)->PosterState;
                }
            }
        }
        /// <summary>
        ...
        public unsafe float* PriorState
        {
            get
            {
                unsafe
                {
                    return ((WCvKalman*)_ptr)->PriorState;
                }
            }
        }
        /// <summary>
        ...
        public unsafe float* DynamMatr
        {
            get
            {
                unsafe
                {
                    return ((WCvKalman*)_ptr)->DynamMatr;
                }
            }
        }
        /// <summary>
        ...
        public unsafe float* MeasurementMatr
        {
            get
            {
                unsafe
                {
                    return ((WCvKalman*)_ptr)->MeasurementMatr;
                }
            }
        }
        /// <summary>
        ...
        public unsafe float* MNCovariance
        {
            get
            {
                unsafe
                {
                    return ((WCvKalman*)_ptr)->MNCovariance;
                }
            }
        }
        /// <summary>
        ...
        public unsafe float* PNCovariance
        {
            get
            {
                unsafe
                {
                    return ((WCvKalman*)_ptr)->PNCovariance;
                }
            }
        }
        /// <summary>
        ...
        public unsafe float* KalmGainMatr
        {
            get
            {
                unsafe
                {
                    return ((WCvKalman*)_ptr)->KalmGainMatr;
                }
            }
        }
        /// <summary>
        ...
        public unsafe float* PriorErrorCovariance
        {
            get
            {
                unsafe
                {
                    return ((WCvKalman*)_ptr)->PriorErrorCovariance;
                }
            }
        }
        /// <summary>
        ...
        public unsafe float* PosterErrorCovariance
        {
            get
            {
                unsafe
                {
                    return ((WCvKalman*)_ptr)->PosterErrorCovariance;
                }
            }
        }
        /// <summary>
