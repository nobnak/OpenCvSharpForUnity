    ...
    public class CvHistogram : DisposableCvObject
    {
        ...
        public CvArr Bins
        {
            get
            {
                ...
                unsafe
                {
                    bins = new IntPtr(((WCvHistogram*)_ptr)->bins);
                }
                switch (Type)
                {
        ...
        public IntPtr BinsPtr
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvHistogram*)_ptr)->bins);
                }
            }
        }
#if LANG_JP
        ...
        public int Dim
        {
            get
            {
                unsafe
                {
                    return ((WCvHistogram*)_ptr)->mat.dims;
                }
            }
        }
#if LANG_JP
        ...
        public PointerAccessor1D_Single Thresh1
        {
            get
            {
                unsafe
                {
                    float* p = ((WCvHistogram*)_ptr)->thresh;
        ...
        public PointerAccessor2D_Single Thresh2
        {
            get
            {
                unsafe
                {
                    float** p = ((WCvHistogram*)_ptr)->thresh2;
        ...
        /// <returns></returns>
#endif
        public void CalcArrBackProject(CvArr[] image, CvArr back_project)
        {
            Cv.CalcArrBackProject(image, back_project, this);
        }
#if LANG_JP
        /// <summary>
        /// バックプロジェクションの計算を行う
        ...
        /// <returns></returns>
#endif
        public void CalcBackProject(IplImage[] image, CvArr back_project)
        {
            Cv.CalcBackProject(image, back_project, this);
        }
        #endregion
        ...
        /// <returns></returns>
#endif
        public void CalcArrBackProjectPatch(CvArr[] image, CvArr dst, CvSize patch_size, HistogramComparison method)
        {
            Cv.CalcArrBackProjectPatch(image, dst, patch_size, this, method);
        }
#if LANG_JP
        /// <summary>
        /// ヒストグラムの比較に基づき画像内部でのテンプレート位置を求める
        ...
        /// <returns></returns>
#endif
        public void CalcArrBackProjectPatch(CvArr[] image, CvArr dst, CvSize patch_size, HistogramComparison method, float factor)
        {
            Cv.CalcArrBackProjectPatch(image, dst, patch_size, this, method, factor);
        }
#if LANG_JP
        /// <summary>
        /// ヒストグラムの比較に基づき画像内部でのテンプレート位置を求める
        ...
        /// <returns></returns>
#endif
        public void CalcBackProjectPatch(CvArr[] image, CvArr dst, CvSize patch_size, HistogramComparison method)
        {
            Cv.CalcArrBackProjectPatch(image, dst, patch_size, this, method);
        }
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public void CalcBackProjectPatch(CvArr[] image, CvArr dst, CvSize patch_size, HistogramComparison method, float factor)
        {
            Cv.CalcArrBackProjectPatch(image, dst, patch_size, this, method, factor);
        }
        #endregion        
...
#endif
        public void GetMinMaxValue(out float min_value, out float max_value)
        {
            Cv.GetMinMaxHistValue(this, out min_value, out max_value);
        }
#if LANG_JP
        /// <summary>
...
#endif
        public void GetMinMaxValue(out float min_value, out float max_value, out int[] min_idx, out int[] max_idx)
        {
            Cv.GetMinMaxHistValue(this, out min_value, out max_value, out min_idx, out max_idx);
        }
        #endregion
        #region Normalize
#if LANG_JP
