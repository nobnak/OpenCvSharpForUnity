    ...
    public class CvSeqBlock : DisposableCvObject
    {
        ...
        public CvSeqBlock Prev
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvSeqBlock*)_ptr)->prev);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvSeqBlock Next
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvSeqBlock*)_ptr)->next);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public int StartIndex
        {
            get
            {
                unsafe
                {
                    return ((WCvSeqBlock*)_ptr)->start_index;
                }
            }
        }
#if LANG_JP
        ...
        public IntPtr Data
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvSeqBlock*)_ptr)->data);
                }
            }
        }
        #endregion
