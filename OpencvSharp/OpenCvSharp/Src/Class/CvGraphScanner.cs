    ...
    public class CvGraphScanner : DisposableCvObject
    {
        ...
        protected override void Dispose(bool disposing)
        {
            if (!this._disposed)
            {
                ...
                try
                {
                    ...
                    if (IsEnabledDispose)
                    {
                        CvInvoke.cvReleaseGraphScanner(ref _ptr);
                    }
                    this._disposed = true;
                }
                finally
        ...
        public CvGraphVtx Vtx
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvGraphScanner*)_ptr)->vtx);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvGraphVtx Dst
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvGraphScanner*)_ptr)->dst);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvGraphEdge Edge
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvGraphScanner*)_ptr)->edge);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvGraph Graph
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvGraphScanner*)_ptr)->graph);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvSeq Stack
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvGraphScanner*)_ptr)->stack);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public int Index
        {
            get
            {
                unsafe
                {
                    return ((WCvGraphScanner*)_ptr)->index;
                }
            }
        }
#if LANG_JP
        ...
        public int Mask
        {
            get
            {
                unsafe
                {
                    return ((WCvGraphScanner*)_ptr)->mask;
                }
            }
        }
        #endregion
