    ...
    public class CvConnectedComp : DisposableCvObject
    {
        ...
        public double Area
        {
            get
            {
                unsafe
                {
                    return ((WCvConnectedComp*)_ptr)->area;
                }
            }
        }
#if LANG_JP
        ...
        public CvScalar Value
        {
            get
            {
                unsafe
                {
                    return ((WCvConnectedComp*)_ptr)->value;
                }
            }
        }
#if LANG_JP
        ...
        public CvRect Rect
        {
            get
            {
                unsafe
                {
                    return ((WCvConnectedComp*)_ptr)->rect;
                }
            }
        }
#if LANG_JP
        ...
        public CvSeq<CvPoint> Contour
        {
            get
            {
                unsafe
                {
                    IntPtr p = new IntPtr(((WCvConnectedComp*)_ptr)->contour);
                    if (p == IntPtr.Zero)
                        return null;
                    else
