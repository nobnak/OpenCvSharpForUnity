...
namespace OpenCvSharp
{
    ...
    public class CvMemStorage : DisposableCvObject
    {
        ...
        {
            this._ptr = CvInvoke.cvCreateMemStorage(block_size);
        ...
        public int Signature 
		{
            get
            {
                unsafe
                {
                    return ((WCvMemStorage*)_ptr)->signature;
                }
            }
		}
#if LANG_JP
		...
		public CvMemBlock Bottom 
		{
            get
            {
                unsafe
                {
                    IntPtr p = new IntPtr(((WCvMemStorage*)_ptr)->bottom);
        ...
        public CvMemBlock Top 
		{
            get
            {
                unsafe
                {
                    IntPtr p = new IntPtr(((WCvMemStorage*)_ptr)->top);
		...
		public CvMemStorage Parent 
		{
            get
            {
                unsafe
                {
                    IntPtr p = new IntPtr(((WCvMemStorage*)_ptr)->parent);
		...
		public int BlockSize 
		{
            get
            {
                unsafe
                {
                    return ((WCvMemStorage*)_ptr)->block_size;
                }
            }
		}
#if LANG_JP
		...
		public int FreeSpace 
		{
            get
            {
                unsafe
                {
                    return ((WCvMemStorage*)_ptr)->free_space;
                }
            }
		}
        #endregion
