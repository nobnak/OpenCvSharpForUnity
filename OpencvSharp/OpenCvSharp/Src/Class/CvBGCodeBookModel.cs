...
namespace OpenCvSharp
{
    ...
    public class CvBGCodeBookModel : DisposableCvObject
    {
        ...
        {
            this._ptr = CvInvoke.cvCreateBGCodeBookModel();
        ...
        public CvSize Size
        {
            get
            {
                unsafe
                {
                    return ((WCvBGCodeBookModel*)_ptr)->size;
                }
            }
            set
            {
                unsafe
                {
                    ((WCvBGCodeBookModel*)_ptr)->size = value;
                }
            }
        }
#if LANG_JP
        ...
        public int T
        {
            get
            {
                unsafe
                {
                    return ((WCvBGCodeBookModel*)_ptr)->t;
                }
            }
            set
            {
                unsafe
                {
                    ((WCvBGCodeBookModel*)_ptr)->t = value;
                }
            }
        }
#if LANG_JP
        ...
        public byte[] CbBounds
        {
            get
            {
                unsafe
                {
                    byte* p = ((WCvBGCodeBookModel*)_ptr)->cbBounds;
        ...
        public byte[] ModMin
        {
            get
            {
                unsafe
                {
                    byte* p = ((WCvBGCodeBookModel*)_ptr)->modMin;
                    return new byte[] { p[0], p[1], p[2] };
                }
            }
            set
        ...
        public byte[] ModMax
        {
            get
            {
                unsafe
                {
                    byte* p = ((WCvBGCodeBookModel*)_ptr)->modMax;
                    return new byte[] { p[0], p[1], p[2] };
                }
            }
            set
        ...
        public IntPtr CbMap
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvBGCodeBookModel*)_ptr)->cbmap);
                }
            }
        }
#if LANG_JP
        ...
        public CvMemStorage Storage
        {
            get
            {
                unsafe
                {
                    WCvMemStorage* p = ((WCvBGCodeBookModel*)_ptr)->storage;
                    if (p == null)
                        return null;
                    else
        ...
        public IntPtr Freelist
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvBGCodeBookModel*)_ptr)->freeList);
                }
            }
        }
        #endregion
