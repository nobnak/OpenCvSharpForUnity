    ...
    public class CvSeqReader : DisposableCvObject 
    {
        ...
        public int HeaderSize
        {
            get
            {
                unsafe
                {
                    return ((WCvSeqReader*)_ptr)->header_size;
                }
            }
        }
        /// <summary>
        ...
        public CvSeq Seq
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvSeqReader*)_ptr)->seq);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvSeqBlock Block
        {
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvSeqReader*)_ptr)->block);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public IntPtr Ptr
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvSeqReader*)_ptr)->ptr);
                }
            }
            internal set
            {
                unsafe
                {
                    ((WCvSeqReader*)_ptr)->ptr = (sbyte*)value;
                }
            }
        }
        /// <summary>
        ...
        public IntPtr BlockMin
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvSeqReader*)_ptr)->block_min);
                }
            }
        }
        /// <summary>
        ...
        public IntPtr BlockMax
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvSeqReader*)_ptr)->block_max);
                }
            }
        }
        /// <summary>
        ...
        public int DeltaIndex
        {
            get
            {
                unsafe
                {
                    return ((WCvSeqReader*)_ptr)->delta_index;
                }
            }
        }
        /// <summary>
        ...
        public IntPtr PrevElem
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvSeqReader*)_ptr)->prev_elem);
                }
            }
        }
#if LANG_JP
