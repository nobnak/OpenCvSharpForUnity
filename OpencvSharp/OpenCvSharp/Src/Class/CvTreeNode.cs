...
namespace OpenCvSharp
{
        ...
        where T : CvTreeNode<T>
    {
        ...
        /// <param name="ptr">struct CvTreeNode*</param>
#endif
        protected virtual void Initialize(IntPtr ptr)
        {
            if (ptr == IntPtr.Zero)
            {
        ...
        public int HeaderSize
        {
            get
            {
                unsafe
                {
                    return ((WCvTreeNode*)_ptr)->header_size;
                }
            }
        }
#if LANG_JP
        ...
        /// <returns></returns>
#endif
        public CvSeq TreeToNodeSeq(int header_size, CvMemStorage storage)
        {
            return Cv.TreeToNodeSeq(this, header_size, storage);
        }
        #endregion
        #endregion
    }
