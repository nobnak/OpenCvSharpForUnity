    ...
    public class CvTypeInfo : DisposableCvObject
    {
		...
		public int HeaderSize
		{
            get
            {
                unsafe
                {
                    return ((WCvTypeInfo*)_ptr)->header_size;
                }
            }
		}	
#if LANG_JP
        ...
        public CvTypeInfo Prev
		{
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvTypeInfo*)_ptr)->prev);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
        ...
        public CvTypeInfo Next
		{
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvTypeInfo*)_ptr)->next);
                }
                if (p == IntPtr.Zero)
                    return null;
                else
		...
		public string TypeName
		{
            get
            {
                unsafe
                {
                    return new string(((WCvTypeInfo*)_ptr)->type_name);
                }
            }
		}	
		...
		public CvIsInstanceFunc IsInstance
		{
			get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvTypeInfo*)_ptr)->is_instance);
                }
        ...
        public CvReleaseFunc Release
		{
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvTypeInfo*)_ptr)->release);
                }
		...
		public CvReadFunc Read
		{
            get 
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvTypeInfo*)_ptr)->read);
                }
		...
		public CvWriteFunc Write
		{
            get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvTypeInfo*)_ptr)->write);
                }
		...
		public CvCloneFunc Clone
		{
			get
            {
                ...
                unsafe
                {
                    p = new IntPtr(((WCvTypeInfo*)_ptr)->clone);
                }
