    ...
    public class CvLineIterator : DisposableCvObject, IEnumerable<CvScalar>
    {
        ...
        public IntPtr Ptr
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvLineIterator*)_ptr)->ptr);
                }
            }
            internal set
            {
                unsafe
                {
                    ((WCvLineIterator*)_ptr)->ptr = (byte*)value;
                }
            }
        }
#if LANG_JP
        ...
        public int Err
        {
            get
            {
                unsafe
                {
                    return ((WCvLineIterator*)_ptr)->err;
                }
            }
            internal set
            {
                unsafe
                {
                    ((WCvLineIterator*)_ptr)->err = value;
                }
            }
        }
#if LANG_JP
        ...
        public int PlusDelta
        {
            get
            {
                unsafe
                {
                    return ((WCvLineIterator*)_ptr)->plus_delta;
                }
            }
            internal set
            {
                unsafe
                {
                    ((WCvLineIterator*)_ptr)->plus_delta = value;
                }
            }
        }
#if LANG_JP
        ...
        public int MinusDelta
        {
            get
            {
                unsafe
                {
                    return ((WCvLineIterator*)_ptr)->minus_delta;
                }
            }
            internal set
            {
                unsafe
                {
                    ((WCvLineIterator*)_ptr)->minus_delta = value;
                }
            }
        }
#if LANG_JP
        ...
        public int PlusStep
        {
            get
            {
                unsafe
                {
                    return ((WCvLineIterator*)_ptr)->plus_step;
                }
            }
            internal set
            {
                unsafe
                {
                    ((WCvLineIterator*)_ptr)->plus_step = value;
                }
            }
        }
#if LANG_JP
        ...
        public int MinusStep
        {
            get
            {
                unsafe
                {
                    return ((WCvLineIterator*)_ptr)->minus_step;
                }
            }
            internal set
            {
                unsafe
                {
                    ((WCvLineIterator*)_ptr)->minus_step = value;
                }
            }
        }
