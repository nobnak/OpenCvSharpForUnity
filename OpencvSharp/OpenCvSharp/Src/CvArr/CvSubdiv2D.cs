    ...
    public class CvSubdiv2D : CvGraph
    {
        ...
        public int QuadEdges
        {
            get
            {
                unsafe
                {
                    return ((WCvSubdiv2D*)_ptr)->quad_edges;
                }
            }
        }
#if LANG_JP
        ...
        public bool IsGeometryValid
        {
            get
            {
                unsafe
                {
                    return ((WCvSubdiv2D*)_ptr)->is_geometry_valid != 0;
                }
            }
        }
#if LANG_JP
        ...
        public uint RecentEdge
        {
            get
            {
                unsafe
                {
                    return ((WCvSubdiv2D*)_ptr)->recent_edge;
                }
            }
        }
#if LANG_JP
        ...
        public CvPoint2D32f TopLeft
        {
            get
            {
                unsafe
                {
                    return ((WCvSubdiv2D*)_ptr)->topleft;
                }
            }
        }
#if LANG_JP
        ...
        public CvPoint2D32f BottomRight
        {
            get
            {
                unsafe
                {
                    return ((WCvSubdiv2D*)_ptr)->bottomright;
                }
            }
        }
        #endregion
        ...
        {
            CvInvoke.cvClearSubdivVoronoi2D(_ptr);
        }
        #endregion
