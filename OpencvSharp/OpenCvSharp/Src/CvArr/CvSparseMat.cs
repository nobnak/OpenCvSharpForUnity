    ...
    public unsafe class CvSparseMat : CvArr, ICloneable
    {
        ...
        public int HashSize
        {
            get
            {
                unsafe
                {
                    return ((WCvSparseMat*)_ptr)->hashsize;
                }
            }
        }
#if LANG_JP
        ...
        public IntPtr HashTable
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvSparseMat*)_ptr)->hashtable);
                }
            }
        }
#if LANG_JP
        ...
        public IntPtr Heap
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvSparseMat*)_ptr)->heap);
                }
            }
        }
#if LANG_JP
        ...
        public int IdxOffset
        {
            get
            {
                unsafe
                {
                    return ((WCvSparseMat*)_ptr)->idxoffset;
                }
            }
        }
#if LANG_JP
        ...
        public int ValOffset
        {
            get
            {
                unsafe
                {
                    return ((WCvSparseMat*)_ptr)->valoffset;
                }
            }
        }
#if LANG_JP
        ...
        public int[] Size
        {
            get
            {
                unsafe
                {
                    ...
                    IntPtr src = new IntPtr(((WCvSparseMat*)_ptr)->size);
