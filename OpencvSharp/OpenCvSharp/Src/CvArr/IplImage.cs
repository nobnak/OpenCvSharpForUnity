...
namespace OpenCvSharp
{
    ...
    { 
        ...
        public IplImage(string filename, LoadMode flags)
        {
            ...
            _ptr = CvInvoke.cvLoadImage(filename, flags);
            if (_ptr == IntPtr.Zero)
            {
        ...
        {
            _ptr = CvInvoke.cvCreateImage(size, depth, channels);
            if (_ptr == IntPtr.Zero)
            {
                throw new OpenCvSharpException("Failed to create IplImage");
            }
...
//            }
        ...
        public int AlphaChannel
        {
            get
            {
                unsafe
                {
                    return ((WIplImage*)_ptr)->alphaChannel;
                }
            }
        }
#if LANG_JP
        ...
        public IntPtr BorderMode
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WIplImage*)_ptr)->BorderMode);
                }
            }
        }
#if LANG_JP
        ...
        public IntPtr BorderConst
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WIplImage*)_ptr)->BorderConst);
                }
            }
        }
#if LANG_JP
        ...
        public IntPtr ColorModel
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WIplImage*)_ptr)->colorModel);
                }
            }
        }
#if LANG_JP
        ...
        public IntPtr ChannelSeq
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WIplImage*)_ptr)->channelSeq);
                }
            }
        }
#if LANG_JP
        ...
        public int DataOrder
        {
            get
            {
                unsafe
                {
                    return ((WIplImage*)_ptr)->dataOrder;
                }
            }
        }
#if LANG_JP
        ...
        public BitDepth Depth
        {
            get
            {
                unsafe
                {
                    return (BitDepth)(((WIplImage*)_ptr)->depth);
                }
            }
        }
#if LANG_JP
        ...
        public IntPtr ImageData
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WIplImage*)_ptr)->imageData);
                }
            }
            set
            {
                unsafe
                {
                    ((WIplImage*)_ptr)->imageData = (byte*)value;
                }
            }
        }
#if LANG_JP
        ...
        public unsafe byte* ImageDataPtr
        {
            get
            {
                return ((WIplImage*)_ptr)->imageData; 
            }
            set
            {
                ((WIplImage*)_ptr)->imageData = value;
            }
        }
#if LANG_JP
        /// <summary>
        ...
        public IntPtr ImageDataOrigin
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WIplImage*)_ptr)->imageDataOrigin);
                }
            }
            private set
            {
                unsafe
                {
                     ((WIplImage*)_ptr)->imageDataOrigin = (byte*)value;
                }
            }
        }
#if LANG_JP
        ...
        public int ImageSize
        {
            get
            {
                unsafe
                {
                    return ((WIplImage*)_ptr)->imageSize;
                }
            }
        }
#if LANG_JP
        ...
        public IntPtr MaskROI
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WIplImage*)_ptr)->maskROI);
                }
            }
        }
#if LANG_JP
        ...
        public int NChannels
        {
            get
            {
                unsafe
                {
                    return ((WIplImage*)_ptr)->nChannels;
                }
            }
        }
        /// <summary>
        ...
        public ImageOrigin Origin
        {
            get
            {
                unsafe
                {
                    return (ImageOrigin)(((WIplImage*)_ptr)->origin);
                }
            }
        }
#if LANG_JP
        ...
        public IntPtr ROIPointer
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WIplImage*)_ptr)->roi);
                }
            }
        }
#if LANG_JP
        ...
        public int WidthStep
        {
            get
            {
                unsafe
                {
                    return ((WIplImage*)_ptr)->widthStep;
                }
            }
        }
#if LANG_JP
        ...
        public IntPtr TileInfo
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WIplImage*)_ptr)->tileInfo);
                }
            }
        }
        #endregion
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            using (DeflateStream gzs = new DeflateStream(ms, CompressionMode.Compress))
            {
                for (int offset = 0; offset < ImageSize; offset += writeLength)
                {
                    ...
                    IntPtr ptr = new IntPtr(ImageData.ToInt64() + offset);
        ...
        protected IplImage(SerializationInfo info, StreamingContext context)
        {
            ...
            // 画像領域を準備
            _ptr = CvInvoke.cvCreateImage(size, depth, nChannels);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException("Failed to create IplImage");
            ...
            {                
                while (true)
                {
                    ...
                    Marshal.Copy(buffer, 0, ptr, readSize);
                    ptr = new IntPtr(ptr.ToInt64() + readSize);
                }
            }
        }
        #endregion
