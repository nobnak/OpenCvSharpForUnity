...
namespace OpenCvSharp
{
    ...
    public unsafe class CvMatND : CvArr, ICloneable
    {
        ...
        public CvMatND(int dims, int[] sizes, MatrixType type)
        {
            ...
            this._ptr = CvInvoke.cvCreateMatND(dims, sizes, type);
        ...
        public IntPtr RefCount
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvMatND*)_ptr)->refcount);
                }
            }
            internal set
            {
                ((WCvMatND*)_ptr)->refcount = (int*)value;
            }
        }
#if LANG_JP
        /// <summary>
        ...
        public IntPtr Data
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvMatND*)_ptr)->data);
                }
            }
            internal set
            {
                unsafe
                {
                    ((WCvMatND*)_ptr)->data = value.ToPointer();
                }
            }
        }
#if LANG_JP
        ...
        public byte* DataByte
        {
            get
            {
                unsafe
                {
                    return (byte*)(((WCvMatND*)_ptr)->data);
                }
            }
        }
#if LANG_JP
        ...
        public short* DataInt16
        {
            get
            {
                unsafe
                {
                    return (short*)(((WCvMatND*)_ptr)->data);
                }
            }
        }
#if LANG_JP
        ...
        public float* DataSingle
        {
            get
            {
                unsafe
                {
                    return (float*)(((WCvMatND*)_ptr)->data);
                }
            }
        }
#if LANG_JP
        ...
        public double* DataDouble
        {
            get
            {
                unsafe
                {
                    return (double*)(((WCvMatND*)_ptr)->data);
                }
            }
        }
#if LANG_JP
        ...
        public PointerAccessor1D_Byte DataArrayByte
        {
            ...
            {                
                if (_dataArrayByte == null)
                {
                    unsafe
                    {
                        byte* p = (byte*)(((WCvMatND*)_ptr)->data);
        ...
        public PointerAccessor1D_Int16 DataArrayInt16
        {
            get
            {
                if (_dataArrayInt16 == null)
                {
                    unsafe
                    {
                        short* p = (short*)(((WCvMatND*)_ptr)->data);
        ...
        public PointerAccessor1D_Single DataArraySingle
        {
            get
            {
                if (_dataArraySingle == null)
                {
                    unsafe
                    {
                        float* p = (float*)(((WCvMatND*)_ptr)->data);
        ...
        public PointerAccessor1D_Double DataArrayDouble
        {
            get
            {
                if (_dataArrayDouble == null)
                {
                    unsafe
                    {
                        double* p = (double*)(((WCvMatND*)_ptr)->data);
