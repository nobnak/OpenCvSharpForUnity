...
namespace OpenCvSharp
{
    partial class CvArr
    {
        ...
        /// <returns></returns>
#endif
        public CvSeq<CvAvgComp> HaarDetectObjects(CvHaarClassifierCascade cascade, CvMemStorage storage, double scaleFactor, int minNeighbors, HaarDetectionType flags, CvSize minSize)
        {
            return Cv.HaarDetectObjects(this, cascade, storage, scaleFactor, minNeighbors, flags, minSize);
        }
        #endregion
        #region HoughCircles
...
#endif
        public void Threshold(CvArr dst, double threshold, double max_value, ThresholdType threshold_type)
        {
            Cv.Threshold(this, dst, threshold, max_value, threshold_type);
        }
        #endregion
        #region Trace
#if LANG_JP
...
#endif
        public void Undistort2(CvArr dst, CvMat intrinsic_matrix, CvMat distortion_coeffs)
        {
            Cv.Undistort2(this, dst, intrinsic_matrix, distortion_coeffs);
        }
#if LANG_JP
        /// <summary>
        /// 半径方向や円周方向のレンズ歪みを補正するために画像を変換する．
        ...
        /// <param name="new_camera_matrix"></param>
#endif
        public void Undistort2(CvArr dst, CvMat intrinsic_matrix, CvMat distortion_coeffs, CvMat new_camera_matrix)
        {
            Cv.Undistort2(this, dst, intrinsic_matrix, distortion_coeffs, new_camera_matrix);
        }
        #endregion
...
#endif
        public void WarpPerspective(CvArr dst, CvMat map_matrix)
        {
            Cv.WarpPerspective(this, dst, map_matrix);
        }
#if LANG_JP
        /// <summary>
        /// 画像の透視変換を行う.
        ...
        /// <param name="flags">A combination of interpolation method and the optional flags.</param>
#endif
        public void WarpPerspective(CvArr dst, CvMat map_matrix, Interpolation flags)
        {
            Cv.WarpPerspective(this, dst, map_matrix, flags);
        }
#if LANG_JP
        /// <summary>
        /// 画像の透視変換を行う.
        ...
        /// <param name="fillval">A value used to fill outliers. </param>
#endif
        public void WarpPerspective(CvArr dst, CvMat map_matrix, Interpolation flags, CvScalar fillval)
        {
            Cv.WarpPerspective(this, dst, map_matrix, flags, fillval);
        }
        #endregion
        #region Watershed
#if LANG_JP
