    ...
    public class CvSeq : CvTreeNode<CvSeq>, ICloneable
    {
        ...
        public override CvSeq HPrev
        {
            get
            {
                unsafe
                {
                    IntPtr p = new IntPtr(((WCvSeq*)_ptr)->h_prev);
        ...
        public override CvSeq HNext
        {
            get
            {
                unsafe
                {
                    IntPtr p = new IntPtr(((WCvSeq*)_ptr)->h_next);
        ...
        public override CvSeq VPrev
        {
            get
            {
                unsafe
                {
                    IntPtr p = new IntPtr(((WCvSeq*)_ptr)->v_prev);
        ...
        public override CvSeq VNext
        {
            get
            {
                unsafe
                {
                    IntPtr p = new IntPtr(((WCvSeq*)_ptr)->v_next);
        ...
        public IntPtr BlockMax
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvSeq*)_ptr)->block_max);
                }
            }
        }
#if LANG_JP
        ...
        public IntPtr Ptr
        {
            get
            {
                unsafe
                {
                    return new IntPtr(((WCvSeq*)_ptr)->ptr);
                }
            }
        }
#if LANG_JP
        ...
        public int DeltaElems
        {
            get
            {
                unsafe
                {
                    return ((WCvSeq*)_ptr)->delta_elems;
                }
            }
        }
#if LANG_JP
        ...
        public CvMemStorage Storage
        {
            get
            {
                unsafe
                {
                    IntPtr p = new IntPtr(((WCvSeq*)_ptr)->storage);
        ...
        public CvSeqBlock First
        {
            get
            {
                unsafe
                {
                    IntPtr p = new IntPtr(((WCvSeq*)_ptr)->first);
