...
namespace OpenCvSharp.Blob
{
    ...
    public class CvBlobs : DisposableCvObject, IDictionary<CvLabel, CvBlob>
    {
        ...
        public CvBlobs()
        {
            this._ptr = CvBlobInvoke.CvBlobs_construct();
        ...
        protected override void Dispose(bool disposing)
        {
            if (!this.disposed)
            {
                ...
                try
                {
                    ...
                    if (IsEnabledDispose)
                    {
                        CvBlobInvoke.cvb_cvReleaseBlobs(_ptr);
                        CvBlobInvoke.CvBlobs_destruct(_ptr);
                    }
                    this.disposed = true;
                }
                finally
        ...
        public virtual void Add(CvLabel key, CvBlob value)
        {
            ...
            CvBlobInvoke.CvBlobs_Add(_ptr, key, value.CvPtr);
        }
#if LANG_JP
        /// <summary>
        ...
        {
            return CvBlobInvoke.CvBlobs_ContainsKey(_ptr, key);
        }
#if LANG_JP
		/// <summary>
        ...
        public virtual ICollection<CvLabel> Keys
        {
            get
            {
                ...
                CvBlobInvoke.CvBlobs_Keys(_ptr, keys);
                return keys;
            }
        }
#if LANG_JP
        ...
        public virtual bool Remove(CvLabel key)
        {
            ...
            {                
                ...
                // mapからの削除
                bool result = CvBlobInvoke.CvBlobs_RemoveAt(_ptr, key);
        ...
        {
            IntPtr valuePtr;
            if (CvBlobInvoke.CvBlobs_TryGetValue(_ptr, key, out valuePtr))
            {
        ...
        public virtual ICollection<CvBlob> Values
        {
            get
            {
                ...
                CvBlobInvoke.CvBlobs_Values(_ptr, values);
        ...
        public virtual CvBlob this[CvLabel key]
        {
            get
            {
                IntPtr p = CvBlobInvoke.CvBlobs_get(_ptr, key);
                if (p == IntPtr.Zero)
                    return null;
                else
                    return new CvBlob(p);
            ...
            set
            {
                ...
                CvBlobInvoke.CvBlobs_set(_ptr, key, v);
            }
        }
        #endregion
        ...
        public virtual void Add(KeyValuePair<CvLabel, CvBlob> item)
        {
            ...
            CvBlobInvoke.CvBlobs_Add(_ptr, item.Key, value);
        }
#if LANG_JP
		/// <summary>
        ...
        {
            IntPtr value = (item.Value == null) ? IntPtr.Zero : item.Value.CvPtr;
            return CvBlobInvoke.CvBlobs_Contains(_ptr, item.Key, value);
        }
#if LANG_JP
        /// <summary>
        ...
        public virtual int Count
        {
            get
            {
                return CvBlobInvoke.CvBlobs_Count(_ptr);
            }
        }
#if LANG_JP
		/// <summary>
        ...
        public virtual bool Remove(KeyValuePair<CvLabel, CvBlob> item)
        {
            ...
            bool result = CvBlobInvoke.CvBlobs_Remove(_ptr, item.Key, item.Value.CvPtr);
        ...
        public IEnumerator<KeyValuePair<CvLabel, CvBlob>> GetEnumerator()
        {
            ...
            CvLabel[] keys = new CvLabel[count];
            IntPtr[] values = new IntPtr[count];
            CvBlobInvoke.CvBlobs_GetKeysAndValues(_ptr, keys, values);
