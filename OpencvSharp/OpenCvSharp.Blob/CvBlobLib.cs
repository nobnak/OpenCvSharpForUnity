...
namespace OpenCvSharp.Blob
{
    ...
    static public class CvBlobLib
    {
        ...
        public static CvLabel GetLabel(IplImage img, uint x, uint y)
        {
            if (img == null)
                throw new ArgumentNullException("img");
        ...
        public static CvLabel GreaterBlob(CvBlobs blobs)
        {
            if (blobs == null)
                throw new ArgumentNullException("blobs");
        ...
        public static CvLabel Label(IplImage img, IplImage imgOut, CvBlobs blobs)
        {
            if (img == null)
                throw new ArgumentNullException("img");
            if (imgOut == null)
