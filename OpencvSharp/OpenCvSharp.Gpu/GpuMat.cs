...
namespace OpenCvSharp.Gpu
{
    ...
    public partial class GpuMat : DisposableCvObject, ICloneable
    {
        ...
        public GpuMat(int rows, int cols, MatrixType type)
        {
            ...
            _ptr = GpuInvoke.GpuMat_new2(rows, cols, type);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        /// <summary>
        ...
        public GpuMat(int rows, int cols, MatrixType type, IntPtr data, uint step)
        {
            ...
            if (cols <= 0)
                throw new ArgumentOutOfRangeException("cols");
            _ptr = GpuInvoke.GpuMat_new3(rows, cols, type, data, step);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        /// <summary>
        ...
        public GpuMat(Mat m)
        {
            ...
            _ptr = GpuInvoke.GpuMat_new4(m.CvPtr);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        /// <summary>
        ...
        public GpuMat(GpuMat m)
        {
            if (m == null)
                throw new ArgumentNullException("m");
            _ptr = GpuInvoke.GpuMat_new5(m.CvPtr);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        /// <summary>
        ...
        {
            _ptr = GpuInvoke.GpuMat_new6(size, type);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        /// <summary>
        ...
        {
            _ptr = GpuInvoke.GpuMat_new7(size, type, data, step);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        /// <summary>
        ...
        public GpuMat(int rows, int cols, MatrixType type, CvScalar s)
        {
            ...
            if (cols <= 0)
                throw new ArgumentOutOfRangeException("cols");
            _ptr = GpuInvoke.GpuMat_new8(rows, cols, type, (CvScalar)s);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        /// <summary>
        ...
        public GpuMat(GpuMat m, CvSlice rowRange, CvSlice colRange)
        {
            if (m == null)
                throw new ArgumentNullException("m");
            _ptr = GpuInvoke.GpuMat_new9(m.CvPtr, rowRange, colRange);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        /// <summary>
        ...
        public GpuMat(GpuMat m, CvRect roi)
        {
            if (m == null)
                throw new ArgumentNullException("m");
            _ptr = GpuInvoke.GpuMat_new10(m.CvPtr, (CvRect)roi);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        /// <summary>
        ...
        {
            _ptr = GpuInvoke.GpuMat_new11(size, type, s);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }      
        #endregion
        ...
        public virtual Mat this[CvRect roi]
        {
            ...
            {
                Mat result = new Mat();
                GpuInvoke.GpuMat_opRange1(_ptr, roi, result.CvPtr);
                return result;
            }
        }
        /// <summary>
        ...
        public virtual Mat this[CvSlice rowRange, CvSlice colRange]
        {
            ...
            {
                Mat result = new Mat();
                GpuInvoke.GpuMat_opRange2(_ptr, rowRange, colRange, result.CvPtr);
                return result;
            }
        }
        /// <summary>
        ...
        public int Flags
        {
            get
            {
                ...
                return GpuInvoke.GpuMat_flags(_ptr);
            }
        }
        /// <summary>
        /// the number of rows
        ...
        public int Rows
        {
            get 
            {
                if (_disposed)
                    throw new ObjectDisposedException("GpuMat");
                return GpuInvoke.GpuMat_rows(_ptr); 
            }
        }
        /// <summary>
        ...
        public int Cols
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("GpuMat");
                return GpuInvoke.GpuMat_cols(_ptr);
            }
        }
        /// <summary>
        ...
        public uint Step
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("GpuMat");
                return GpuInvoke.GpuMat_step(_ptr);
            }
        }
        /// <summary>
        /// pointer to the data
        ...
        public IntPtr Data
        {
            get
            {
                ...
                unsafe
                {
                    return (IntPtr)GpuInvoke.GpuMat_data(_ptr);
                }
            }
        }
        /// <summary>
        ...
        public IntPtr RefCount
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("GpuMat");
                return (IntPtr)GpuInvoke.GpuMat_refcount(_ptr);
            }
        }
        /// <summary>
        ...
        public IntPtr DataStart
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("GpuMat");
                return (IntPtr)GpuInvoke.GpuMat_datastart(_ptr);
            }
        }
        /// <summary>
        /// helper fields used in locateROI and adjustROI
        ...
        public IntPtr DataEnd
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("GpuMat");
                return (IntPtr)GpuInvoke.GpuMat_dataend(_ptr);
            }
        }
        /// <summary>
        /// 
        ...
        public MatrixType Type
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("GpuMat");
                return GpuInvoke.GpuMat_type(_ptr);
            }
        }
        /// <summary>
        /// 
        ...
        public uint ElemSize
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("GpuMat");
                return GpuInvoke.GpuMat_elemSize(_ptr);
            }
        }
        /// <summary>
        /// 
        ...
        public uint ElemSize1
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("GpuMat");
                return GpuInvoke.GpuMat_elemSize1(_ptr);
            }
        }
        /// <summary>
        /// 
        ...
        public int Depth 
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("GpuMat");
                return GpuInvoke.GpuMat_depth(_ptr);
            }
        }
        /// <summary>
        /// 
        ...
        public int Channels
        {
            get 
            {
                if (_disposed)
                    throw new ObjectDisposedException("GpuMat");
                return GpuInvoke.GpuMat_channels(_ptr);
            }
        }
        /// <summary>
        /// 
        ...
        public GpuMat Row(int y)
        {
            ...
            GpuInvoke.GpuMat_row(_ptr, y, outValue.CvPtr);
            return outValue;
        }
        /// <summary>
        ...
        public GpuMat Col(int x)
        {
            if (_disposed)
                throw new ObjectDisposedException("GpuMat");
            GpuMat outValue = new GpuMat();
            GpuInvoke.GpuMat_col(_ptr, x, outValue.CvPtr);
            return outValue;
        }
        /// <summary>
        ...
        public GpuMat RowRange(int startrow, int endrow)
        {
            if (_disposed)
                throw new ObjectDisposedException("GpuMat");
            GpuMat outValue = new GpuMat();
            GpuInvoke.GpuMat_rowRange(_ptr, startrow, endrow, outValue.CvPtr);
            return outValue;
        }
        /// <summary>
        /// returns a new matrix header for the specified row span
        ...
        public GpuMat ColRange(int startcol, int endcol) 
        {
            if (_disposed)
                throw new ObjectDisposedException("GpuMat");
            GpuMat outValue = new GpuMat();
            GpuInvoke.GpuMat_colRange(_ptr, startcol, endcol, outValue.CvPtr);
            return outValue;
        }
        /// <summary>
        /// returns a new matrix header for the specified column span
        ...
        public GpuMat Clone()
        {
            if (_disposed)
                throw new ObjectDisposedException("GpuMat");
            GpuMat outValue = new GpuMat();
            GpuInvoke.GpuMat_clone(_ptr, outValue.CvPtr);
            return outValue;
        }
        ...
        public void CopyTo(GpuMat m)
        {
            ...
            if (m == null)
                throw new ArgumentNullException("m");
            GpuInvoke.GpuMat_copyTo1(_ptr, m.CvPtr);
        }
        /// <summary>
        ...
        public void CopyTo(GpuMat m, GpuMat mask)
        {
            ...
            GpuInvoke.GpuMat_copyTo2(_ptr, m.CvPtr, mask.CvPtr);
        }
        ...
        public void ConvertTo(Mat dst, MatrixType rtype, double alpha = 1, double beta = 0)
        {
            if (_disposed)
                throw new ObjectDisposedException("GpuMat");
            GpuInvoke.GpuMat_convertTo(_ptr, dst.CvPtr, (int)rtype, alpha, beta);
        }
        ...
        {
            GpuInvoke.GpuMat_assignTo(_ptr, m.CvPtr, -1);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public void AssignTo(GpuMat m, MatrixType type)
        {
            ...
            if (m == null)
                throw new ArgumentNullException("m");
            GpuInvoke.GpuMat_assignTo(_ptr, m.CvPtr, (int)type);
        }
        ...
        public GpuMat SetTo(CvScalar s, GpuMat mask = null)
        {
            ...
            GpuMat dst = new GpuMat();
            GpuInvoke.GpuMat_setTo(_ptr, s, maskPtr, dst.CvPtr);
            return dst;
        }
        ...
        public GpuMat Reshape(int cn, int rows)
        {
            if (_disposed)
                throw new ObjectDisposedException("GpuMat");
            GpuMat outValue = new GpuMat();
            GpuInvoke.GpuMat_reshape(_ptr, cn, rows, outValue.CvPtr);
            return outValue;
        }
        ...
        public void Create(int rows, int cols, MatrixType type)
        {
            if (_disposed)
                throw new ObjectDisposedException("GpuMat");
            GpuInvoke.GpuMat_create1(_ptr, rows, cols, type);
        }
        /// <summary>
        /// allocates new matrix data unless the matrix already has specified size and type.
        /// previous data is unreferenced if needed.
        ...
        public void Create(CvSize size, MatrixType type)
        {
            if (_disposed)
                throw new ObjectDisposedException("GpuMat");
            GpuInvoke.GpuMat_create2(_ptr, size, type);
        }
        /*
        /// <summary>
        ...
        public void Swap(GpuMat mat)
        {
            ...
            GpuInvoke.GpuMat_swap(_ptr, mat.CvPtr);
        }
        /// <summary>
        ...
        public void LocateROI(out CvSize wholeSize, out CvPoint ofs)
        {
            if (_disposed)
                throw new ObjectDisposedException("GpuMat");
            GpuInvoke.GpuMat_locateROI(_ptr, out wholeSize, out ofs);
        }
        ...
        public GpuMat AdjustROI(int dtop, int dbottom, int dleft, int dright)
        {
            if (_disposed)
                throw new ObjectDisposedException("GpuMat");
            GpuMat dst = new GpuMat();
            GpuInvoke.GpuMat_adjustROI(_ptr, dtop, dbottom, dleft, dright, dst.CvPtr);
            return dst;
        }
        ...
        public GpuMat T()
        {
            if (_disposed)
                throw new ObjectDisposedException("GpuMat");
            GpuMat dst = new GpuMat();
            GpuInvoke.GpuMat_t(_ptr, dst.CvPtr);
            return dst;
        }
        ...
        public bool IsContinuous()
        {
            if (_disposed)
                throw new ObjectDisposedException("GpuMat");
            return GpuInvoke.GpuMat_isContinuous(_ptr);
        }
        ...
        public unsafe byte* Ptr(int y = 0)
        {
            if (_disposed)
                throw new ObjectDisposedException("GpuMat");
            return GpuInvoke.GpuMat_ptr(_ptr, y);
        }
        #endregion
        #endregion
    }
