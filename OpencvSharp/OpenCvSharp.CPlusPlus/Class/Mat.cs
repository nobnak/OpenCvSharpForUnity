...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public partial class Mat : DisposableCvObject, ICloneable
    {
        ...
        public Mat(string filename, LoadMode flags)
        {
            ...
            {
                _ptr = CppInvoke.Mat_new8(img.CvPtr, true);
            }
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        ...
        public Mat(int rows, int cols, MatrixType type)
        {
            ...
            _ptr = CppInvoke.Mat_new2(rows, cols, type);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        /// <summary>
        ...
        public Mat(int rows, int cols, MatrixType type, CvScalar s)
        {
            ...
            if (cols <= 0)
                throw new ArgumentOutOfRangeException("cols");
            _ptr = CppInvoke.Mat_new3(rows, cols, type, (CvScalar)s);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        /// <summary>
        ...
        public Mat(int rows, int cols, MatrixType type, IntPtr data, uint step)
        {
            ...
            if (cols <= 0)
                throw new ArgumentOutOfRangeException("cols");
            _ptr = CppInvoke.Mat_new4(rows, cols, type, data, step);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        /// <summary>
        ...
        public Mat(Mat m, CvSlice rowRange, CvSlice colRange)
        {
            ...
            _ptr = CppInvoke.Mat_new5(m.CvPtr, rowRange, colRange);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        /// <summary>
        ...
        public Mat(Mat m, CvRect roi)
        {
            if (m == null)
                throw new ArgumentNullException("m");
            _ptr = CppInvoke.Mat_new6(m.CvPtr, (CvRect)roi);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        /// <summary>
        ...
        public Mat(CvMat m, bool copyData)
        {
            if (m == null)
                throw new ArgumentNullException("m");
            _ptr = CppInvoke.Mat_new7(m.CvPtr, copyData);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
            if (copyData == false)
        ...
        public Mat(IplImage img, bool copyData)
        {
            ...
            _ptr = CppInvoke.Mat_new8(img.CvPtr, copyData);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
            if (copyData == false)
                IsEnabledDispose = false;
        ...
        public Mat(Array vec, BitDepth depth, bool copyData)
        {
            ...
            using (ScopedGCHandle vecPtr = new ScopedGCHandle(vec, GCHandleType.Pinned))
            {
                ...
                _ptr = CppInvoke.Mat_new9(vecPtr.AddrOfPinnedObject(), vec.Length, depthType, elemSize, copyData);
                if (_ptr == IntPtr.Zero)
                    throw new OpenCvSharpException();
            }
        }
        ...
        public static Mat operator +(Mat src1, Mat src2)
        {
            ...
            if (src1._disposed || src2._disposed)
                throw new ObjectDisposedException("Mat");
            Mat dst = new Mat();
        ...
        public int Flags
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("Mat");
                return CppInvoke.Mat_flags(_ptr);
            }
        }
        /// <summary>
        /// the number of rows
        ...
        public int Rows
        {
            get 
            {
                if (_disposed)
                    throw new ObjectDisposedException("Mat");
                return CppInvoke.Mat_rows(_ptr); 
            }
        }
        /// <summary>
        ...
        public int Cols
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("Mat");
                return CppInvoke.Mat_cols(_ptr);
            }
        }
        /// <summary>
        ...
        public uint Step
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("Mat");
                return CppInvoke.Mat_step(_ptr);
            }
        }
        /// <summary>
        /// pointer to the data
        ...
        public IntPtr Data
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("Mat");
                return CppInvoke.Mat_data(_ptr);
            }
        }
        /// <summary>
        ...
        public IntPtr RefCount
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("Mat");
                return CppInvoke.Mat_refcount(_ptr);
            }
        }
        /// <summary>
        ...
        public IntPtr DataStart
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("Mat");
                return CppInvoke.Mat_datastart(_ptr);
            }
        }
        /// <summary>
        /// helper fields used in locateROI and adjustROI
        ...
        public IntPtr DataEnd
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("Mat");
                return CppInvoke.Mat_dataend(_ptr);
            }
        }
        /// <summary>
        /// 
        ...
        public virtual Mat this[CvRect roi]
        {
            ...
            {
                Mat result = new Mat();
                CppInvoke.Mat_opRange1(_ptr, roi, result.CvPtr);
                return result;
            }
        }
        /// <summary>
        ...
        public virtual Mat this[CvSlice rowRange, CvSlice colRange]
        {
            ...
            {
                Mat result = new Mat();
                CppInvoke.Mat_opRange2(_ptr, rowRange, colRange, result.CvPtr);
                return result;
            }
        }
        /// <summary>
        ...
        public Mat Row(int y)
        {
            if (_disposed)
                throw new ObjectDisposedException("Mat");
            Mat outValue = new Mat();
            CppInvoke.Mat_row(_ptr, y, outValue.CvPtr);
            return outValue;
        }
        /// <summary>
        ...
        public Mat Col(int x)
        {
            if (_disposed)
                throw new ObjectDisposedException("Mat");
            Mat outValue = new Mat();
            CppInvoke.Mat_col(_ptr, x, outValue.CvPtr);
            return outValue;
        }
        /// <summary>
        ...
        public Mat RowRange(int startrow, int endrow)
        {
            if (_disposed)
                throw new ObjectDisposedException("Mat");
            Mat outValue = new Mat();
            CppInvoke.Mat_rowRange(_ptr, startrow, endrow, outValue.CvPtr);
            return outValue;
        }
        /// <summary>
        /// returns a new matrix header for the specified row span
        ...
        public Mat ColRange(int startcol, int endcol) 
        {
            if (_disposed)
                throw new ObjectDisposedException("Mat");
            Mat outValue = new Mat();
            CppInvoke.Mat_colRange(_ptr, startcol, endcol, outValue.CvPtr);
            return outValue;
        }
        /// <summary>
        /// returns a new matrix header for the specified column span
        ...
        public Mat Diag(MatDiagType d)
        {
            if (_disposed)
                throw new ObjectDisposedException("Mat");
            Mat outValue = new Mat();
            CppInvoke.Mat_diag1(_ptr, d, outValue.CvPtr);
            return outValue;
        }
        ...
        public Mat Clone()
        {
            if (_disposed)
                throw new ObjectDisposedException("Mat");
            Mat outValue = new Mat();
            CppInvoke.Mat_clone(_ptr, outValue.CvPtr);
            return outValue;
        }
        ...
        public void CopyTo(Mat m)
        {
            ...
            if (m == null)
                throw new ArgumentNullException("m");
            CppInvoke.Mat_copyTo1(_ptr, m.CvPtr);
        }
        /// <summary>
        ...
        public void CopyTo(Mat m, Mat mask)
        {
            ...
            CppInvoke.Mat_copyTo2(_ptr, m.CvPtr, mask.CvPtr);
        }
        ...
        public void ConvertTo(Mat dst, MatrixType rtype, double alpha = 1, double beta = 0)
        {
            if (_disposed)
                throw new ObjectDisposedException("Mat");
            CppInvoke.Mat_convertTo(_ptr, dst.CvPtr, rtype, alpha, beta);
        }
        ...
        {
            CppInvoke.Mat_assignTo(_ptr, m.CvPtr, -1);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public void AssignTo(Mat m, MatrixType type)
        {
            ...
            if (m == null)
                throw new ArgumentNullException("m");
            CppInvoke.Mat_assignTo(_ptr, m.CvPtr, (int)type);
        }
        ...
        public Mat SetTo(Mat value, Mat mask = null)
        {
            ...
            Mat dst = new Mat();
            CppInvoke.Mat_setTo(_ptr, value.CvPtr, maskPtr, dst.CvPtr);
            return dst;
        }
        ...
        public Mat Reshape(int cn, int rows)
        {
            if (_disposed)
                throw new ObjectDisposedException("Mat");
            Mat outValue = new Mat();
            CppInvoke.Mat_reshape(_ptr, cn, rows, outValue.CvPtr);
            return outValue;
        }
        ...
        public Mat Cross(Mat m) 
        {
            ...
            if (m == null)
                throw new ArgumentNullException("m");
            Mat outValue = new Mat();
            CppInvoke.Mat_cross(_ptr, m.CvPtr, outValue.CvPtr);
            return outValue;
        }
        ...
        public double Dot(Mat m)
        {
            ...
            if (m == null)
                throw new ArgumentNullException("m");
            return CppInvoke.Mat_dot(_ptr, m.CvPtr);
        }
        ...
        public void Create(int rows, int cols, MatrixType type)
        {
            if (_disposed)
                throw new ObjectDisposedException("Mat");
            CppInvoke.Mat_create(_ptr, rows, cols, type);
        }
        /// <summary>
        /// allocates new matrix data unless the matrix already has specified size and type.
        /// previous data is unreferenced if needed.
        ...
        public void LocateROI(out CvSize wholeSize, out CvPoint ofs)
        {
            if (_disposed)
                throw new ObjectDisposedException("Mat");
            CppInvoke.Mat_locateROI(_ptr, out wholeSize, out ofs);
        }
        ...
        public Mat AdjustROI(int dtop, int dbottom, int dleft, int dright)
        {
            if (_disposed)
                throw new ObjectDisposedException("Mat");
            Mat dst = new Mat();
            CppInvoke.Mat_adjustROI(_ptr, dtop, dbottom, dleft, dright, dst.CvPtr);
            return dst;
        }
        ...
        public Mat T()
        {
            if (_disposed)
                throw new ObjectDisposedException("Mat");
            Mat dst = new Mat();
            CppInvoke.Mat_t(_ptr, dst.CvPtr);
            return dst;
        }
        ...
        public Mat Inv(InvertMethod method = InvertMethod.LU)
        {
            if (_disposed)
                throw new ObjectDisposedException("Mat");
            Mat dst = new Mat();
            CppInvoke.Mat_inv(_ptr, method, dst.CvPtr);
            return dst;
        }
        ...
        public CvMat ToCvMat()
        {
            ...
            CppInvoke.Mat_opCvMat(_ptr, mat.CvPtr);
            return mat;
        }
        /// <summary>
        /// converts header to IplImage; no data is copied
        ...
        public IplImage ToIplImage()
        {
            ...
            CppInvoke.Mat_opIplImage(_ptr, ipl.CvPtr);
            return ipl;
        }
