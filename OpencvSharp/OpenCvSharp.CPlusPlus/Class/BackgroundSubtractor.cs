...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public abstract class BackgroundSubtractor : DisposableCvObject
    {
        ...
        public virtual void GetBackgroundImage(Mat backgroundImage)
        {
            ...
            CppInvoke.BackgroundSubtractor_getBackgroundImage(_ptr, backgroundImage.CvPtr);
        }
    }
    ...
    public class BackgroundSubtractorMOG : BackgroundSubtractor
    {
        ...
        {
            _ptr = CppInvoke.BackgroundSubtractorMOG_new1();
            if (_ptr == IntPtr.Zero)
        ...
        {
            _ptr = CppInvoke.BackgroundSubtractorMOG_new2(history, nmixtures, backgroundRatio, noiseSigma);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        #endregion
        ...
        protected override void Dispose(bool disposing)
        {
            if (!this._disposed)
            {
                ...
                try
                {
                    ...
                    if (IsEnabledDispose)
                    {
                        CppInvoke.BackgroundSubtractorMOG_delete(_ptr);
                    }
                    this._disposed = true;
                }
                finally
        ...
        public override void Run(Mat image, Mat fgmask, double learningRate = 0)
        {
            ...
            CppInvoke.BackgroundSubtractorMOG_operator(_ptr, image.CvPtr, fgmask.CvPtr, learningRate);
        }
        ...
        {
            CppInvoke.BackgroundSubtractorMOG_initialize(_ptr, frameSize, frameType);
        }
    ...
    public class BackgroundSubtractorMOG2 : BackgroundSubtractor
    {
        ...
        {
            _ptr = CppInvoke.BackgroundSubtractorMOG2_new1();
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        /// <summary>
        ...
        {
            _ptr = CppInvoke.BackgroundSubtractorMOG2_new2(history, varThreshold, bShadowDetection ? 1 : 0);
            if (_ptr == IntPtr.Zero)
                throw new OpenCvSharpException();
        }
        #endregion
        ...
        protected override void Dispose(bool disposing)
        {
            if (!this._disposed)
            {
                ...
                try
                {
                    ...
                    if (IsEnabledDispose)
                    {
                        CppInvoke.BackgroundSubtractorMOG2_delete(_ptr);
                    }
                    this._disposed = true;
                }
                finally
        ...
        public override void Run(Mat image, Mat fgmask, double learningRate = 0)
        {
            ...
            if (fgmask == null)
                throw new ArgumentNullException("fgmask");
            CppInvoke.BackgroundSubtractorMOG2_operator(_ptr, image.CvPtr, fgmask.CvPtr, learningRate);
        }
        ...
        public override void GetBackgroundImage(Mat backgroundImage)
        {
            if (backgroundImage == null)
                throw new ArgumentNullException("backgroundImage");
            CppInvoke.BackgroundSubtractorMOG2_getBackgroundImage(_ptr, backgroundImage.CvPtr);
        }
        ...
        public virtual void Initialize(CvSize frameSize, int frameType)
        {
            CppInvoke.BackgroundSubtractorMOG2_initialize(_ptr, frameSize, frameType);
        }
