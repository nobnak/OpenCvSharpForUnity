...
namespace OpenCvSharp.CPlusPlus
{
    ...
    /// </summary>
#endif
    public partial class MatND : DisposableCvObject, ICloneable
    {
        #region Const
        /// <summary>
        /// 
        ...
        */
        ...
        public int Flags
        {
            get
            {
                ...
                return CppInvoke.MatND_flags_get(_ptr);
            }
        }
        /// <summary>
        ...
        public int Dims
        {
            get 
            {
                if (_disposed)
                    throw new ObjectDisposedException("MatND");
                return CppInvoke.MatND_dims_get(_ptr); 
            }
        }
        /// <summary>
        /// pointer to the data
        ...
        public IntPtr Data
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("MatND");
                return CppInvoke.MatND_data_get(_ptr);
            }
        }
        /// <summary>
        ...
        public IntPtr RefCount
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("MatND");
                return CppInvoke.MatND_refcount_get(_ptr);
            }
        }
        /// <summary>
        ...
        public IntPtr DataStart
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("MatND");
                return CppInvoke.MatND_datastart_get(_ptr);
            }
        }
        /// <summary>
        /// helper fields used in locateROI and adjustROI
        ...
        public IntPtr DataEnd
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("MatND");
                return CppInvoke.MatND_dataend_get(_ptr);
            }
        }
        /// <summary>
        ...
        public int[] Size
        {
            get
            {
                if (_disposed)
                    throw new ObjectDisposedException("MatND");
                IntPtr p = CppInvoke.MatND_size_get(_ptr);
        ...
        public virtual MatND this[CvSlice[] ranges]
        {
            get
            {
                ...
                CppInvoke.MatND_opRange(_ptr, ranges, result.CvPtr);
                return result;
            }
        }
        #endregion
        ...
        public void CopyTo(MatND m)
        {
            ...
            CppInvoke.MatND_copyTo1(_ptr, m.CvPtr);
        }
        /// <summary>
        ...
        public void CopyTo(MatND m, MatND mask)
        {
            ...
            CppInvoke.MatND_copyTo2(_ptr, m.CvPtr, mask.CvPtr);
        }
        ...
        public void ConvertTo(MatND dst, MatrixType rtype, double alpha = 1, double beta = 0)
        {
            if (_disposed)
                throw new ObjectDisposedException("MatND");
            CppInvoke.MatND_convertTo(_ptr, dst.CvPtr, rtype, alpha, beta);
        }
        ...
        public MatND SetTo(CvScalar s, MatND mask = null)
        {
            ...
            MatND dst = new MatND();
            CppInvoke.MatND_setTo(_ptr, s, maskPtr, dst.CvPtr);
            return dst;
        }
        ...
        public MatND Reshape(int newcn, int newndims = 0, int[] newsz = null)
        {
            if (_disposed)
                throw new ObjectDisposedException("MatND");
            MatND dst = new MatND();
            CppInvoke.MatND_reshape(_ptr, newcn, newndims, newsz, dst.CvPtr);
            return dst;
        }
        ...
        public Mat ToMat()
        {
            ...
            CppInvoke.MatND_opMat(_ptr, mat.CvPtr);
            return mat;
        }
        /// <summary>
        /// converts header to CvMatND; no data is copied
        ...
        public CvMatND ToCvMatND()
        {
            ...
            mat.IsEnabledDispose = false;
            CppInvoke.MatND_opCvMatND(_ptr, mat.CvPtr);
            return mat;
        }
        ...
        public IntPtr Ptr(int i0)
        {
            if (_disposed)
                throw new ObjectDisposedException("MatND");
            return CppInvoke.MatND_ptr1(_ptr, i0);
        }
        /// <summary>
        /// return pointer to the element 
        /// </summary>
        ...
        public IntPtr Ptr(int i0, int i1)
        {
            if (_disposed)
                throw new ObjectDisposedException("MatND");
            return CppInvoke.MatND_ptr2(_ptr, i0, i1);
        }
        /// <summary>
        /// return pointer to the element 
        /// </summary>
        ...
        public IntPtr Ptr(int i0, int i1, int i2)
        {
            if (_disposed)
                throw new ObjectDisposedException("MatND");
            return CppInvoke.MatND_ptr3(_ptr, i0, i1, i2);
        }
        /// <summary>
        /// return pointer to the element 
        /// </summary>
        ...
        public IntPtr Ptr(params int[] idx)
        {
            if (_disposed)
                throw new ObjectDisposedException("MatND");
            return CppInvoke.MatND_ptr4(_ptr, idx);
        } 
        #endregion
        #endregion
    }
