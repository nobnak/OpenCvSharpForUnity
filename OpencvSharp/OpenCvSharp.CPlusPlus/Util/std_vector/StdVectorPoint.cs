...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class StdVectorPoint : DisposableCvObject, IStdVector
    {
        ...
        {
            this._ptr = CppInvoke.vector_cvPoint_new1();
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public StdVectorPoint(int size)
        {
            ...
            this._ptr = CppInvoke.vector_cvPoint_new2(new IntPtr(size));
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public StdVectorPoint(CvPoint[] data)
        {
            ...
            this._ptr = CppInvoke.vector_cvPoint_new3(data, new IntPtr(data.Length));
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (!this._disposed)
            {
                try
                {
                    if (IsEnabledDispose)
                    {
                        CppInvoke.vector_cvPoint_delete(_ptr);
                    }
                    this._disposed = true;
                }
                finally
        ...
        public int Size
        {
            get { return CppInvoke.vector_cvPoint_getSize(_ptr).ToInt32(); }
        }
        /// <summary>
        /// &amp;vector[0]
        /// </summary>
        ...
        {
            get { return CppInvoke.vector_cvPoint_getPointer(_ptr); }
        }
        #endregion
