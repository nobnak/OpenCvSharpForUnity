...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class StdVectorVec3f : DisposableCvObject, IStdVector
    {
        ...
        {
            this._ptr = CppInvoke.vector_cvVec3f_new1();
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public StdVectorVec3f(int size)
        {
            ...
            this._ptr = CppInvoke.vector_cvVec3f_new2(new IntPtr(size));
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public StdVectorVec3f(Vec3fElem[] data)
        {
            ...
            this._ptr = CppInvoke.vector_cvVec3f_new3(data, new IntPtr(data.Length));
        }
        ...
        public int Size
        {
            get { return CppInvoke.vector_cvVec3f_getSize(_ptr).ToInt32(); }
        }
        /// <summary>
        /// &amp;vector[0]
        /// </summary>
        ...
        {
            get { return CppInvoke.vector_cvVec3f_getPointer(_ptr); }
        }
        #endregion
