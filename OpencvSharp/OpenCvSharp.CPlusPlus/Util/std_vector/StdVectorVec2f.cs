...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class StdVectorVec2f : DisposableCvObject, IStdVector
    {
        ...
        {
            this._ptr = CppInvoke.vector_cvVec2f_new1();
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public StdVectorVec2f(int size)
        {
            ...
            this._ptr = CppInvoke.vector_cvVec2f_new2(new IntPtr(size));
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public StdVectorVec2f(Vec2fElem[] data)
        {
            ...
            this._ptr = CppInvoke.vector_cvVec2f_new3(data, new IntPtr(data.Length));
        }
        ...
        public int Size
        {
            get { return CppInvoke.vector_cvVec2f_getSize(_ptr).ToInt32(); }
        }
        /// <summary>
        /// &amp;vector[0]
        /// </summary>
        ...
        {
            get { return CppInvoke.vector_cvVec2f_getPointer(_ptr); }
        }
        #endregion
