...
#pragma warning restore 1591
        ...
        public CvSVM()
        {
            _ptr = MLInvoke.CvSVM_construct_default();
		...
		public CvSVM(CvMat trainData, CvMat responses, CvMat varIdx, CvMat sampleIdx, CvSVMParams @params)
	    {
            ...
            _ptr = MLInvoke.CvSVM_construct_training(
				trainData.CvPtr, 
				responses.CvPtr, 
				varIdxPtr, 
				sampleIdxPtr, 
            ...
            if (!disposed)
            {
                ...
                try
                {
                    ...
                    if (IsEnabledDispose)
                    {
                        try
                        {
                            MLInvoke.CvSVM_destruct(_ptr);
                        }
                        catch
                        {
                            try
                            {
                                MLInvoke.CvSVM_clear(_ptr);
                            }
                            catch { }
                        }
                    }
	    ...
	    {
		    return MLInvoke.CvSVM_get_support_vector_count(_ptr);
	    }
		...
		public PointerAccessor1D_Single GetSupportVector(int i)
        {
            unsafe
            {
                float* p = MLInvoke.CvSVM_get_support_vector(_ptr, i);
	    ...
	    public CvSVMParams GetParams()
	    {
            ...
            MLInvoke.CvSVM_get_params(_ptr, ref p);
        ...
        {
            return MLInvoke.CvSVM_get_var_count(_ptr);
        }
        ...
        public virtual float Predict(CvMat sample)
	    {
		    ...
		    return MLInvoke.CvSVM_predict(_ptr, sample.CvPtr);
	    }
		...
		public override void Write(CvFileStorage storage, String name) 
        {
            ...
            MLInvoke.CvSVM_write(_ptr, storage.CvPtr, name);
        }
		...
		public override void Read(CvFileStorage storage, CvFileNode node) 
        {
            ...
            MLInvoke.CvSVM_read(_ptr, storage.CvPtr, node.CvPtr);
        }
		#endregion
        #endregion
    }
