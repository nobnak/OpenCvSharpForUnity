...
namespace OpenCvSharp.MachineLearning
{
	...
	public class CvForestTree : CvDTree
	{
        ...
        protected override void Dispose(bool disposing)
        {
            if (!disposed)
            {
                ...
                try
                {
                    ...
                    if (IsEnabledDispose)
                    {
                        MLInvoke.CvForestTree_destruct(_ptr);
                    }
                    disposed = true;
                }
                finally
        ...
        public virtual bool Train( CvDTreeTrainData trainData, CvMat subsampleIdx, CvRTrees forest )
        {
            ...
            return MLInvoke.CvForestTree_train(_ptr, trainData.CvPtr, subsampleIdx.CvPtr, forest.CvPtr);
        }
        ...
        {
            return MLInvoke.CvForestTree_get_var_count(_ptr);
        }
        ...
        public virtual void Read(CvFileStorage fs, CvFileNode node, CvRTrees forest, CvDTreeTrainData data)
        {
            ...
            MLInvoke.CvForestTree_read(_ptr, fs.CvPtr, node.CvPtr, forest.CvPtr, data.CvPtr);
        }
        #endregion
	}
}
