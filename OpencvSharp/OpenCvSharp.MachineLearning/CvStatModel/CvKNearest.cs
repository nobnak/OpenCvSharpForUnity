...
namespace OpenCvSharp.MachineLearning
{
    ...
    public class CvKNearest : CvStatModel
    {
        ...
        public CvKNearest()
        {
			_ptr = MLInvoke.CvKNearest_construct_default();
		...
		public CvKNearest(CvMat trainData, CvMat responses, CvMat sampleIdx, bool isRegression, int maxK)
        {
            ...
            _ptr = MLInvoke.CvKNearest_construct_training(
                trainData.CvPtr, 
                responses.CvPtr,
                sampleIdxPtr, 
                isRegression, 
        ...
        protected override void Dispose(bool disposing)
        {
            if (!disposed)
            {
                ...
                try
                {
                    ...
                    if (IsEnabledDispose)
                    {
                        MLInvoke.CvKNearest_destruct(_ptr);
        ...
        public int GetMaxK()
        {
            return MLInvoke.CvKNearest_get_max_k(_ptr);
        }
#if LANG_JP
        /// <summary>
        /// 
        ...
        {
            return MLInvoke.CvKNearest_get_var_count(_ptr);
        }
#if LANG_JP
        /// <summary>
        /// 
        ...
        {
            return MLInvoke.CvKNearest_get_sample_count(_ptr);
        }
#if LANG_JP
        /// <summary>
        /// 
        ...
        {
            return MLInvoke.CvKNearest_is_regression(_ptr);
        }
        ...
        {
            MLInvoke.CvKNearest_clear(_ptr);
        }
		#endregion
        #endregion
    }
