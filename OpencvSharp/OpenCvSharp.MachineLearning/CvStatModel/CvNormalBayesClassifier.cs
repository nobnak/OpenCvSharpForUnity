...
namespace MachineLearning
{
    ...
    public class CvNormalBayesClassifier : CvStatModel
    {
        ...
        {
            _ptr = MLInvoke.CvNormalBayesClassifier_construct_default();
		...
		public CvNormalBayesClassifier(CvMat trainData, CvMat responses, CvMat varIdx, CvMat sampleIdx)
        {
            ...
            _ptr = MLInvoke.CvNormalBayesClassifier_construct_training(trainData.CvPtr, responses.CvPtr, varIdxPtr, sampleIdxPtr);
            NotifyMemoryPressure(SizeOf);
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (!disposed)
            {
                ...
                try
                {
                    ...
                    if (IsEnabledDispose)
                    {
                        MLInvoke.CvNormalBayesClassifier_destruct(_ptr);
        ...
        public virtual float Predict(CvMat sample, CvMat results)
        {
            ...
            return MLInvoke.CvNormalBayesClassifier_predict(_ptr, sample.CvPtr, resultsPtr);
        }
        ...
        public virtual bool Train(CvMat trainData, CvMat responses, CvMat varIdx, CvMat sampleIdx, bool update)
        {
            ...
            return MLInvoke.CvNormalBayesClassifier_train(_ptr, trainData.CvPtr, responses.CvPtr, varIdxPtr, sampleIdxPtr, update);
        }
        ...
        {
            MLInvoke.CvNormalBayesClassifier_clear(_ptr);
        }
		...
		public override void Write(CvFileStorage storage, string name)
        {
            ...
            MLInvoke.CvNormalBayesClassifier_write(_ptr, storage.CvPtr, name);
        }
		...
		public override void Read(CvFileStorage storage, CvFileNode node)
        {
            ...
            MLInvoke.CvNormalBayesClassifier_read(_ptr, storage.CvPtr, node.CvPtr);
        }
		# endregion
        # endregion
    }
