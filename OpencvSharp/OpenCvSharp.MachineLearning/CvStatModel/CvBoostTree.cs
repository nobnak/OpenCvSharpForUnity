...
namespace OpenCvSharp.MachineLearning
{
	...
	public class CvBoostTree : CvDTree
	{
        ...
        protected override void Dispose(bool disposing)
        {
            if (!disposed)
            {
                ...
                try
                {
                    ...
                    if (IsEnabledDispose)
                    {
                        MLInvoke.CvBoostTree_destruct(_ptr);
		...
		public virtual bool Train(CvDTreeTrainData trainData, CvMat subsampleIdx, CvBoost ensemble)
        {
			...
			return MLInvoke.CvBoostTree_train(_ptr, trainData.CvPtr, subsampleIdx.CvPtr, ensemblePtr);
        }
        ...
        {
			MLInvoke.CvBoostTree_scale(_ptr, s);
        }
		...
		public virtual void Read(CvFileStorage fs, CvFileNode node, CvBoost ensemble, CvDTreeTrainData data)
        {
			...
			MLInvoke.CvBoostTree_read(_ptr, fs.CvPtr, node.CvPtr, ensemble.CvPtr, data.CvPtr);
        }
        ...
        {
			MLInvoke.CvBoostTree_clear(_ptr);
        }
		#endregion
	}
}
