...
namespace OpenCvSharp.MachineLearning
{
    ...
    public class CvERTrees : CvRTrees
	{
        ...
        protected override void Dispose(bool disposing)
        {
            if (!disposed)
            {
                ...
                try
                {
                    ...
                    if (IsEnabledDispose)
                    {
                        MLInvoke.CvERTrees_destruct(_ptr);
                    }
                    disposed = true;
                }
                finally
            ...
            CvMat varIdx, CvMat sampleIdx, CvMat varType, CvMat missingMask, CvRTParams @params)
        {
            ...
            return MLInvoke.CvERTrees_train1(_ptr, trainData.CvPtr, tflag, responses.CvPtr, varIdxPtr, sampleIdxPtr, varTypePtr, missingMaskPtr, @params.CvPtr);
        }
        ...
        public bool Train(CvMLData data, CvRTParams @params)
        {
            ...
            return MLInvoke.CvERTrees_train2(_ptr, data.CvPtr, @params.CvPtr);
        }
        ...
        {
            return MLInvoke.CvERTrees_grow_forest(_ptr, termCrit);
        }
        #endregion
	}
}
