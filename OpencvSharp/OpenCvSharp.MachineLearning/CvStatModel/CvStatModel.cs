...
#pragma warning restore 1591
        ...
        {
            MLInvoke.CvStatModel_clear(_ptr);
        }
        ...
        {   
            ...
            MLInvoke.CvStatModel_save(_ptr, filename, name);
        }
        ...
        public virtual void Load(string filename, string name)
        {
            ...
            MLInvoke.CvStatModel_load(_ptr, filename, name);
        }
        ...
        public virtual void Write(CvFileStorage storage, string name)
        {
            ...
            MLInvoke.CvStatModel_write(_ptr, storage.CvPtr, name);
        }
        ...
        public virtual void Read(CvFileStorage storage, CvFileNode node)
        {
            ...
            MLInvoke.CvStatModel_read(_ptr, storage.CvPtr, node.CvPtr);
        }
        #endregion
    }
}
