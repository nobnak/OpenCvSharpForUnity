...
#pragma warning restore 1591
        ...
        {
            _ptr = MLInvoke.cv_EM_new(nclusters, covMatType, termCrit);
        ...
        public virtual float[] Predict(CvMat sample, CvMat probs)
	    {
            ...
            float ret0, ret1;
            MLInvoke.cv_EM_predict(_ptr, sample.CvPtr, probsPtr, out ret0, out ret1);
        ...
        public virtual bool Train(CvMat samples, CvMat sampleIdx, CvMat logLikelihoods, CvMat labels, CvMat probs)
	    {
            ...
            return MLInvoke.cv_EM_train(_ptr, samples.CvPtr, logLikelihoodsPtr, labelsPtr, probsPtr) != 0;
	    }
