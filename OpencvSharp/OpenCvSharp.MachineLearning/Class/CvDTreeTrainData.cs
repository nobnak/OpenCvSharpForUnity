...
namespace OpenCvSharp.MachineLearning
{
	...
	public class CvDTreeTrainData : DisposableCvObject
	{
		...
		{
			_ptr = MLInvoke.CvDTreeTrainData_construct_default();
		}
#if LANG_JP
		/// <summary>
        /// ポインタから初期化
			...
			CvDTreeParams @params, bool shared, bool addLabels)
		{
			...
			_ptr = MLInvoke.CvDTreeTrainData_construct_training(
				trainData.CvPtr, 
				(int)tflag, 
				responses.CvPtr, 
				varIdxPtr, 
            ...
            if (!disposed)
            {
                ...
                try
                {
                    ...
                    if (IsEnabledDispose)
                    {
                        try
                        {
                            MLInvoke.CvDTreeTrainData_destruct(_ptr);
                        }
                        catch (Exception ex1)
                        {
                            ...
                            try
                            {
                                MLInvoke.CvDTreeTrainData_clear(_ptr);
                            }
                            catch (Exception ex2)
                            {
		...
		{
			get { return MLInvoke.CvDTreeTrainData_sample_count(_ptr); }
		}
#if LANG_JP
		/// <summary>
		/// 
		...
		public int VarAll
		{
            get { return MLInvoke.CvDTreeTrainData_var_all(_ptr); }
		}
#if LANG_JP
		/// <summary>
		/// 
		...
		public int VarCount
		{
            get { return MLInvoke.CvDTreeTrainData_var_count(_ptr); }
		}
#if LANG_JP
		/// <summary>
		/// 
		...
		{
            get { return MLInvoke.CvDTreeTrainData_max_c_count(_ptr); }
		}
		...
		{
            get { return MLInvoke.CvDTreeTrainData_ord_var_count(_ptr); }
		}
#if LANG_JP
		/// <summary>
		/// 
		...
		{
            get { return MLInvoke.CvDTreeTrainData_cat_var_count(_ptr); }
		}
		...
		{
            get { return MLInvoke.CvDTreeTrainData_have_labels(_ptr); }
		}
#if LANG_JP
		/// <summary>
		/// 
		...
		{
            get { return MLInvoke.CvDTreeTrainData_have_priors(_ptr); }
		}
#if LANG_JP
		/// <summary>
		/// 
		...
		{
            get { return MLInvoke.CvDTreeTrainData_is_classifier(_ptr); }
		}
		...
		public int BufCount
		{
            get { return MLInvoke.CvDTreeTrainData_buf_count(_ptr); }
		}
#if LANG_JP
		/// <summary>
		/// 
		...
		public int BufSize
		{
            get { return MLInvoke.CvDTreeTrainData_buf_size(_ptr); }
		}
#if LANG_JP
		/// <summary>
		/// 
		...
		public bool Shared
		{
            get { return MLInvoke.CvDTreeTrainData_shared(_ptr); }
		}
#if LANG_JP
        /// <summary>
        /// 
        ...
        public CvRNG Rng
        {
            get 
            { 
                UInt64 state = MLInvoke.CvDTreeTrainData_rng(_ptr);
		...
		public CvMat CatCount
		{
			get
			{ 
				IntPtr p = MLInvoke.CvDTreeTrainData_cat_count(_ptr);
				if(p == IntPtr.Zero)
					return null;
		...
		public CvMat CatOfs
		{
			get
			{
                IntPtr p = MLInvoke.CvDTreeTrainData_cat_ofs(_ptr);
                if (p == IntPtr.Zero)
                    return null;
                else
                    return new CvMat(p, false);
		...
		public CvMat CatMap
		{
			get
			{
                IntPtr p = MLInvoke.CvDTreeTrainData_cat_map(_ptr);
                if (p == IntPtr.Zero)
                    return null;
                else
                    return new CvMat(p, false);
		...
		public CvMat Counts
		{
			get
			{
                IntPtr p = MLInvoke.CvDTreeTrainData_counts(_ptr);
                if (p == IntPtr.Zero)
                    return null;
			    return new CvMat(p, false);
			}
		...
		public CvMat Buf
		{
			get
			{
                IntPtr p = MLInvoke.CvDTreeTrainData_buf(_ptr);
                if (p == IntPtr.Zero)
                    return null;
                else
                    return new CvMat(p, false);
		...
		public CvMat Direction
		{
			get
			{
                IntPtr p = MLInvoke.CvDTreeTrainData_direction(_ptr);
                if (p == IntPtr.Zero)
                    return null;
			    return new CvMat(p, false);
			}
		...
		public CvMat SplitBuf
		{
			get
			{
                IntPtr p = MLInvoke.CvDTreeTrainData_split_buf(_ptr);
                if (p == IntPtr.Zero)
                    return null;
			    return new CvMat(p, false);
			}
		...
		public CvMat VarIdx
		{
			get
			{
                IntPtr p = MLInvoke.CvDTreeTrainData_var_idx(_ptr);
                if (p == IntPtr.Zero)
                    return null;
			    return new CvMat(p, false);
			}
		...
		public CvMat VarType
		{
			get
			{
                IntPtr p = MLInvoke.CvDTreeTrainData_var_type(_ptr);
                if (p == IntPtr.Zero)
                    return null;
			    return new CvMat(p, false);
			}
		...
		public CvMat Priors
		{
			get
			{
                IntPtr p = MLInvoke.CvDTreeTrainData_priors(_ptr);
                if (p == IntPtr.Zero)
                    return null;
			    return new CvMat(p, false);
			}
		...
		{
			return MLInvoke.CvDTreeTrainData_get_num_classes(_ptr);
		}
#if LANG_JP
        /// <summary>
        /// 
		...
		{
			return MLInvoke.CvDTreeTrainData_get_var_type(_ptr, vi);
		}
#if LANG_JP
        /// <summary>
        /// 
		...
		{
			return MLInvoke.CvDTreeTrainData_get_work_var_count(_ptr);
		}
        ...
        public virtual PointerAccessor1D_Int32 GetClassLabels(CvDTreeNode n, int[] labels_buf)
		{
            ...
            IntPtr p = MLInvoke.CvDTreeTrainData_get_class_labels(_ptr, n.CvPtr, labels_buf);
        ...
        public virtual PointerAccessor1D_Single GetOrdResponses(CvDTreeNode n, float[] values_buf, int[] sample_indices_buf)
        {
            ...
            IntPtr p = MLInvoke.CvDTreeTrainData_get_ord_responses(_ptr, n.CvPtr, values_buf, sample_indices_buf);
        ...
        public virtual PointerAccessor1D_Int32 GetLabels(CvDTreeNode n, int[] labels_buf)
		{
            ...
            IntPtr p = MLInvoke.CvDTreeTrainData_get_cv_labels(_ptr, n.CvPtr, labels_buf);
            return new PointerAccessor1D_Int32(p);
		}
#if LANG_JP
        /// <summary>
        ...
        public virtual PointerAccessor1D_Int32 GetCatVarData(CvDTreeNode n, int vi, int[] cat_values_buf)
		{
            ...
            IntPtr p = MLInvoke.CvDTreeTrainData_get_cat_var_data(_ptr, n.CvPtr, vi, cat_values_buf);
            return new PointerAccessor1D_Int32(p);
        ...
        public virtual void GetOrdVarData(CvDTreeNode n, int vi, float[] ord_values_buf, int[] sorted_indices_buf, float[][] ord_values, int[][] sorted_indices, int[] sample_indices_buf)
		{
            ...
            MLInvoke.CvDTreeTrainData_get_ord_var_data(_ptr, n.CvPtr, vi, ord_values_buf, sorted_indices_buf, ord_values, sorted_indices, sample_indices_buf);	
		}
#if LANG_JP
        /// <summary>
        /// 
		...
		public virtual int GetChildBufIdx(CvDTreeNode n)
		{
			...
			return MLInvoke.CvDTreeTrainData_get_child_buf_idx(_ptr, n.CvPtr);
		}
		#endregion
	}
}
