...
namespace OpenCvSharp.MachineLearning
{
    ...
    public class CvRTParams : CvDTreeParams, ICvPtrHolder
    {
		...
		{
			_ptr = MLInvoke.CvRTParams_construct_default();
		}
            ...
            : base(maxDepth, minSampleCount, regressionAccuracy, useSurrogates, maxCategories, 0, false, false, priors)
        {
            ...
            _ptr = MLInvoke.CvRTParams_construct(maxDepth, minSampleCount, regressionAccuracy, useSurrogates, maxCategories,
        ...
        protected override void Dispose(bool disposing)
        {
            if (!disposed)
            {
                ...
                try
                {
                    ...
                    if (IsEnabledDispose)
                    {
                        MLInvoke.CvRTParams_destruct(_ptr);
                    }
                    disposed = true;
                }
                finally
        ...
        {
            get { return MLInvoke.CvRTParams_calc_var_importance_get(_ptr); }
            set { MLInvoke.CvRTParams_calc_var_importance_set(_ptr, value); }
        }
#if LANG_JP
        /// <summary>
        ...
        {
            get { return MLInvoke.CvRTParams_nactive_vars_get(_ptr); }
            set { MLInvoke.CvRTParams_nactive_vars_set(_ptr, value); }
        }
#if LANG_JP
        /// <summary>
        /// forestの成長に対する終了条件． 
        ...
        {
            get { return MLInvoke.CvRTParams_term_crit_get(_ptr); }
            set { MLInvoke.CvRTParams_term_crit_set(_ptr, value); }
        }
		#endregion
    }
}
